...
<div class="container">
    <div class="row justify-content-center text-dark">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><b>Register Volunteer</b></div>

                <div class="card-body">
                    <form method="POST" action="{{ route('registerVolunteer') }}">
                        @csrf

                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label justify-content-end d-flex">Name</label>
                        ...
                        <div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label justify-content-end d-flex">{{ __('Phone Number') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="address" class="col-md-4 col-form-label justify-content-end d-flex">{{ __('Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label justify-content-end d-flex">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label justify-content-end d-flex">{{ __('Password') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label justify-content-end d-flex">{{ __('Confirm Password') }}</label>
