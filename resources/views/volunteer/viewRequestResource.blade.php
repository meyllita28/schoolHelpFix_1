            ...
            <div class="col-6">
                <div class="card my-3 shadow">
                    ...
                    <div class="card-body" >
                        ...
                        <div class="row mb-3">
                            <label class="col-md-3 col-form-label text-md-end">Resource Type</label>
                            <label class="col-md-9 col-form-label text-md-end">: {{$request->res_resource_type}}</label>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-3 col-form-label text-md-end">Number Required</label>
                            <label class="col-md-9 col-form-label text-md-end">: {{$request->res_number_required}}</label>
                        </div>
                        <div class="row mb-3">
